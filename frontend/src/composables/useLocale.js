...
const UI_TRANSLATIONS = {
  en: {
    ...
    tagFilterModeInclude: 'Include this tag (click to exclude instead)',
    tagFilterModeExclude: 'Excluding this tag (click to include instead)',
    followEvents: 'Follow',
  ...
  ru: {
    ...
    tagFilterModeInclude: 'Показывать с этим тегом (нажмите, чтобы исключить)',
    tagFilterModeExclude: 'Исключать этот тег (нажмите, чтобы показывать)',
